...
Chaque profil de sort commence par les mêmes
...
La portée de la plupart des sorts est exprimée
...
Quand la description du sort spécifie que la
...
Le MJ peut également statuer que certains
...
L’effet d’un sort se propage en lignes droites depuis
...
Les sorts d’ illusion abusent les sens et l’esprit d’autrui.
...
Votre sort raffermit la robustesse et la déter-
...
au-delà du 3e. Chacune de ces créatures doit être
...
L' _anticipation_ prend également fin si sa composante
...
**_Voyage magique._** La téléportation et le voyage
...
crée le sort _corde enchantée_ , sont fermés tant qu'ils
sont dans la sphère.
**_Créatures et objets._** Les créatures et objets
...
plus dans la sphère.
**_Dissipation de la magie._** Les sorts et effets
magiques tels que _dissipation de la magie_ restent
sans effet dans la sphère. De même, les sphères
produites par différents sorts de _champ antimagie_
...
par un emplacement du 2e niveau ou supérieur,
vous pouvez cibler une créature de plus par niveau
d'emplacement au-delà du 1er. Les créatures ainsi
...
bénéficie de _détection de l'invisibilité_ ou de la vision
lucide, par exemple) perçoit un globe lumineux et
intangible de la taille de votre poing.

##### Clignotement

_Transmutation du 3e niveau_
...
_Nécromancie du 8e niveau_

**Temps d'incantation :** 1 heure
**Portée :** contact
**Composantes :** V, S, M (un diamant d'une valeur minimale de 1 000 po et au moins 15 cm^3 de chair
...
0,3 m^3 de matière non vivante (90 x 60 x 60 cm).
...
Chaque créature prise dans un cylindre d'un rayon
de 3 m, haut de 12 m et centré sur un point à portée
...
_Divination du 1er niveau (rituel)_
...
par le sort _enchevêtrement_ à libérer une créature
entravée.

##### Communion

_Divination du 5e niveau (rituel)_
...
**_À plus haut niveau._** Lorsque vous lancez ce sort
par un emplacement du 6e n iveau ou supérieur,
les dégâts augmentent de 1d8 par niveau
d'emplacement au-delà du 5e.
...
Convulsion. La créature est prise d'atroces
tremblements. La créature est désavantagée aux
tests de Dextérité, aux jets de sauvegarde de Dextérité
...
un autre.
**_Contrôle du courant._** Vous réorientez le cours
...
effet.
**_Crue._** Vous faites monter le niveau de toutes les
...
_Invocation du 6e niveau (rituel)_
...
propre dans un récipient ouvert à portée. Une autre
...
_Sort mineur de transmutation_
...
à la vie que par le biais du sort _résurrection suprême_
ou _souhait_.
...
par le sort _alarme_ , un _glyphe de garde_ ou une fosse
...
_Divination du 4e niveau (rituel)_
...
_Nécromancie du 2e niveau (rituel)_

**Temps d'incantation :** 1 action
**Portée :** contact
**Composantes :** V, S, M (une pincée de sel et une pièce de cuivre disposée sur chacun des yeux du cadavre, qui doivent y rester pour toute la durée)
**Durée :** 10 jours
...
**_1. Rouge._** La cible subit 10d6 dégâts de feu
en cas d'échec, la moitié en cas de réussite.
**_2. Orange._** La cible subit 10d6 dégâts d'acide
en cas d'échec, la moitié en cas de réussite.
**_3. Jaune._** La cible subit 10d6 dégâts de foudre
en cas d'échec, la moitié en cas de réussite.
**_4. Vert._** La cible subit 10d6 dégâts de poison
en cas d'échec, la moitié en cas de réussite.
**_5. Bleu._** La cible subit 10d6 dégâts de froid
en cas d'échec, la moitié en cas de réussite.
**_6. Indigo._** En cas d'échec, la cible est entravée.
Elle effectue un jet de sauvegarde de Constitution
...
**_7. Violet._** En cas d'échec, la cible est aveuglée. Elle
...
**_Chaînes._** De lourdes chaînes fermement ancrées
...
**_Détention miniature._** La cible est rapetissée
...
la créature au centre d'un _cercle magique_ inversé
...
de _guérison_ , _restauration suprême_ ou _souhait_.
...
même le sort _souhait_ et les sorts ou effets de
...
_flamme éternelle_ , mais ni l'étouffer ni l'éteindre.
...
du 7 e. Ces créatures doivent se trouver dans un rayon
...
_Transmutation du 3e niveau (rituel)_
...
**_À plus haut niveau._** Lorsque vous lancez ce sort
par un emplacement du 7 e niveau ou supérieur,
la barrière bloque les sorts d'un niveau de plus
par niveau d'emplacement au-delà du 6 e.
...
de 1d8 par niveau d'emplacement au-delà du 3 e.
...
par un emplacement du 6e niveau ou supérieur,
vous pouvez cibler une créature de plus par niveau
d'emplacement au-delà du 5e. Les créatures ainsi
ciblées doivent toutes se trouver dans un rayon
de 9 m les unes des autres.
...
d'emplacement au-delà du 2e. Les humanoïdes ainsi
...
de vous.
Fuis. La cible consacre son tour à s'éloigner de vous
...
_Abjuration du 6e niveau (rituel)_
...
ceux que crée le sort _portail_. Le sort proscrit tout
...
le biais du sort _changement de plan_.
...
ou 8 e niveau, le quadruple avec un emplacement
du 9 e niveau.
...
par niveau d'emplacement au-delà du 5e.
...
6 e ou 7e niveau, le triple avec un emplacement du
8 e ou 9e niveau.
...
du 6 e ou 7e niveau, le triple avec un emplacement
du 8 e ou 9e niveau.
...
niveaux d'emplacement de sort au-delà du 2e.
...
sort _métamorphose_ par exemple, le sort ne parvient
pas à la localiser.
...
**_Main agrippeuse._** La main tente d'agripper une
...
**_Main impérieuse._** La main tente de pousser une
...
Le sort _délivrance des malédictions_ met fin à cet effet.
...
7 e ou 8e niveau, la durée passe à 24 heures. Si vous
...
Endormie. La cible tombe inconsciente. Elle reprend
conscience si elle subit des dégâts ou si une autre
...
_Enchantement du 2e niveau (rituel)_
...
niveau d'emplacement au-delà du 2 e.
...
Choisissez un objet manufacturé en métal, tel qu'une
arme ou une armure métallique intermédiaire ou
...
l'objet (si elle en a la possibilité). Si elle ne peut pas
le lâcher, elle est désavantagée à ses jets d'attaque
...
**_Adaptation aquatique._** Vous adaptez votre corps
...
Le sort _délivrance des malédictions_ ou _restauration
suprême_ lancé sur la cible lui rend sa mémoire d'origine.
**_À plus haut niveau._** Si vous lancez ce sort par
un emplacement du 6e niveau ou supérieur, vous
...
_Illusion du 3e niveau (rituel)_
...
de 1d6 par niveau d'emplacement au-delà du 6 e.
...
elle le reste pour toute la durée du sort. Un _sceptre
d'oblitération_ détruit un mur prismatique, mais
un _champ antimagie_ est sans effet sur lui.

**_1. Rouge._** La créature subit 10d6 dégâts de feu
...
par la lumière vive que produit le sort _lumière du
jour_ ou un sort comparable de niveau supérieur
ou égal.
    **_7. Violette._** En cas d'échec, la créature est aveuglée.
...
_Évocation du 3e niveau (rituel)_
**Temps d'incantation :** 1 minute
...
le voir (les créatures protégées par le sort _cercle
magique_ ou _protection contre le mal et le bien_ ne
...
- Vous nettoyez ou souillez en un instant un objet
    dont le volume ne dépasse pas 30 litres (ou 0,03 m^3 ).
- Vous refroidissez, réchauffez ou parfumez de la
    matière inerte pendant 1 heure, à condition que
    son volume ne dépasse pas 30 litres (ou 0,03 m^3 ).
...
**_Escaliers._** Tous les escaliers de la zone protégée
sont envahis de filandres de la première à la dernière
marche (équivalent du sort _toile d'araignée_ ). Tant
que persiste le sort _protections et sceaux_ , cette masse
filandreuse se reconstitue en 10 minutes si on la brûle
ou l'arrache.
**_Portes._** Toutes les portes de la zone protégée sont
magiquement verrouillées, comme si elles étaient
condamnées par le sort _verrou magique_. De plus,
vous pouvez assortir un maximum de dix portes
d'une illusion (équivalent de la fonction d'objet
illusoire du sort _illusion mineure_ ) afin qu'elles
passent pour de simples pans de mur.
**_Autres effets du sort._** Vous pouvez disposer une
combinaison des effets magiques suivants au sein
de la zone protégée.

- Des _lumières dansantes_ dans quatre couloirs.
    Vous pouvez définir une séquence simple que
    les lumières répètent tant que le sort persiste.
- _Bouche magique_ en deux endroits.
- _Nuage nauséabond_ en deux endroits. Les vapeurs
...
- Une _bourrasque_ constante dans un couloir ou
    une pièce.
- Une _suggestion_ en un lieu. Choisissez une zone
    carrée d'un maximum de 1,50 m de côté ; toute
    créature qui y entre ou la traverse est soumise
    mentalement à la _suggestion_.

Toute la zone protégée irradie la magie. Une
_dissipation de la magie_ lancée sur un effet donné,
si elle réussit, n'élimine que cet effet.
Si vous lancez quotidiennement ce sort pendant
un an sur une structure donnée, _protections et sceaux_
y devient permanent.

##### Purification de la nourriture et de l'eau

_Transmutation du 1er niveau (rituel)_
...
À plus haut niveau. Lorsque vous lancez ce sort
par un emplacement du 7e ou 8e niveau, la durée
est de 1 an. Lorsque vous lancez ce sort par un
emplacement du 9e niveau, le sort persiste jusqu'à
...
**_Protection contre l'énergie._** Les créatures affectées
...
**_Repos éternel._** Les dépouilles enterrées dans
la zone ne peuvent pas être transformées en morts-
vivants.
**_Silence._** Aucun son ne peut émaner de l'intérieur
de la zone et aucun son ne peut y pénétrer.
**_Ténèbres._** Les ténèbres envahissent la zone.
...
**_Terreur._** Les créatures affectées sont effrayées
tant qu'elles restent dans la zone.
**_Vulnérabilité à l'énergie._** Les créatures affectées
...
Un emplacement de sort du 5 e niveau permet
...
**Portée :** contact
**Composantes :** V, S, M (de la neige ou de la glace en quantité suffisante pour modeler une réplique grandeur nature de la créature ; des cheveux, des
...
par niveau d'emplacement au-delà du 1 er.
...
À plus haut niveau. Lorsque vous lancez ce sort
par un emplacement du 6e niveau ou supérieur, les
soins augmentent de 1d8 par niveau d'emplacement
au-delà du 5e.
...
- Permettre à un maximum de vingt créatures que
    ...
    parmi ceux décrits pour le sort _restauration suprême_.
...
- Modifier un événement récent en faisant rejouer
    ...
    s'adapte alors à ce nouveau résultat. _Souhait_ peut
...
**Temps d'incantation :** 1 action
**Portée :** 9 m
**Composantes :** V, S, M (un hémisphère de cristal limpide et un autre de même taille en gomme
arabique)
**Durée :** concentration, jusqu'à 1 minute
...
Le sort _désintégration_ , s'il cible le globe, le détruit
...
9 e niveau, la durée passe à un an et un jour.

##### Symbole

_Abjuration du 7e niveau_
...
**_Désespoir._** Chaque cible effectue un jet de
...
**_Discorde._** Chaque cible effectue un jet de
...
**_Terreur._** Chaque cible effectue un jet de sauvegarde
de Sagesse et devient effrayée pendant 1 minute
...
**Zone
comparable Déviation Sur place**
Cercle
permanent
...
**_Familiarité._** « Cercle permanent » fait référence
...
**_Sur place._** Vous et votre groupe (ou l'objet ciblé)
arrivez à l'endroit souhaité.
**_Déviation._** Vous et votre groupe (ou l'objet ciblé)
...
la zone peut tenter un test
d'Intelligence (Investigation) assorti de votre DD
...
_Illusion du 1er niveau (rituel)_
**Temps d'incantation :** 1 minute
**Portée :** contact
...
**_Crevasses._** Des crevasses se forment dans la zone
...
ci-après).
**_Bâtiments._** Le séisme inflige 50 dégâts contondants
...
Lancer _déblocage_ sur l'objet réprime _verrou magique_
pendant 10 minutes.
